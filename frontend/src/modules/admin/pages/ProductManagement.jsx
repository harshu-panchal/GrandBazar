                                    ...
                                    <td className="px-6 py-5 align-middle">
                                        <div className="flex items-center gap-3 min-w-0">
                                            <div className="h-11 w-11 shrink-0 rounded-xl overflow-hidden bg-slate-100 ring-1 ring-slate-200 shadow-sm">
                                                <img src={getProductImageUrl(p.mainImage || p.images?.[0])} alt={p.name} onError={handleProductImageError} className="h-full w-full object-cover group-hover:scale-110 transition-transform duration-500" />
                                            </div>
                                                            ...
                                                            {suggestedAddons.filter((s) => !formData.addons.includes(s.productId)).map((s) => (
                                                                ...
                                                                >
                                                                    <div className="w-10 h-10 rounded-lg bg-slate-100 overflow-hidden flex-shrink-0">
                                                                        {s.mainImage ? (
                                                                            <img src={s.mainImage} alt={s.name} onError={handleProductImageError} className="w-full h-full object-cover" />
                                                                        ) : (
                                                            ...
                                                            >
                                                                ...
                                                                >
                                                                    <div className="w-12 h-12 rounded-lg bg-slate-100 overflow-hidden flex-shrink-0">
                                                                        {prod.mainImage ? (
                                                                            <img src={prod.mainImage} alt={prod.name} onError={handleProductImageError} className="w-full h-full object-cover" />
                                                                        ) : (
                                            ...
                                            <div className="space-y-3">
                                                ...
                                                <div className="flex flex-col md:flex-row items-start gap-6">
                                                    <div className="w-48 aspect-square rounded-2xl border-2 border-dashed border-slate-200 bg-slate-50 flex flex-col items-center justify-center group hover:border-primary hover:bg-primary/5 transition-all cursor-pointer overflow-hidden relative">
                                                        ...
                                                        />
                                                        {formData.mainImage ? (
                                                            <img src={formData.mainImage} alt="Main Preview" onError={handleProductImageError} className="w-full h-full object-cover" />
                                                        ) : (
                                                    ...
                                                    {(formData.galleryImages || []).length > 0 ? (
                                                        formData.galleryImages.map((image, index) => (
                                                            <div key={`${image}-${index}`} className="group relative aspect-square rounded-2xl overflow-hidden border border-slate-200 bg-slate-50 shadow-sm">
                                                                <img src={image} alt={`Gallery ${index + 1}`} onError={handleProductImageError} className="h-full w-full object-cover" />
                                                                <button
                                                                    type="button"
                                                                    onClick={() => setFormData({
                                                                        ...formData,
                    ...
                    <div className="flex items-center gap-4 mb-6 p-4 bg-slate-50 rounded-2xl border border-slate-100">
                        <div className="h-16 w-16 bg-white rounded-xl shadow-sm overflow-hidden flex items-center justify-center border border-slate-100">
                            {viewingVariants?.mainImage || viewingVariants?.images?.[0] || viewingVariants?.galleryImages?.[0] ? (
                                <img src={viewingVariants.mainImage || viewingVariants.images?.[0] || viewingVariants.galleryImages?.[0]} alt="" onError={handleProductImageError} className="h-full w-full object-cover" />
                            ) : (
