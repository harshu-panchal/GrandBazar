      ...
      {analytics?.settlements?.length > 0 && (
        <Card className="p-5">
          ...
          <div className="overflow-x-auto">
            <table className="min-w-full text-sm mobile-table-card">
              <thead>
              ...
              <tbody>
                {analytics.settlements.map((row, i) => (
                  <tr key={i} className="border-b border-slate-50">
                    <td className="py-3 pr-4" data-label="Metric">Orders with seller-funded rewards</td>
                    <td className="py-3 text-right font-medium" data-label="Value">{row.orderCount}</td>
                  </tr>
                ))}
                <tr>
                  <td className="py-3 pr-4 font-bold" data-label="Metric">Total reward cost</td>
                  <td className="py-3 text-right font-bold text-amber-700" data-label="Value">₹{totals.settlement.toLocaleString("en-IN")}</td>
                </tr>
              </tbody>
            </table>
          </div>
