export const NOTIFICATION_EVENTS = Object.freeze({
  ...
  RETURN_QC_REQUESTED: "RETURN_QC_REQUESTED",
  RETURN_QC_PASSED: "RETURN_QC_PASSED",
  RETURN_QC_FAILED: "RETURN_QC_FAILED",
  SELLER_ACCOUNT_APPROVED: "SELLER_ACCOUNT_APPROVED",
  SELLER_ACCOUNT_REJECTED: "SELLER_ACCOUNT_REJECTED",
  STORE_APPLICATION_APPROVED: "STORE_APPLICATION_APPROVED",
  STORE_APPLICATION_REJECTED: "STORE_APPLICATION_REJECTED",
  NEW_DELIVERY_APPLICATION: "NEW_DELIVERY_APPLICATION",
  NEW_SELLER_APPLICATION: "NEW_SELLER_APPLICATION",
  SUPPORT_TICKET_MESSAGE: "SUPPORT_TICKET_MESSAGE",
  LOW_STOCK_ALERT: "LOW_STOCK_ALERT",
  ORDER_NEEDS_MANUAL_REASSIGNMENT: "ORDER_NEEDS_MANUAL_REASSIGNMENT",
  ...
  EXTRA_PAYMENT_REQUIRED: "EXTRA_PAYMENT_REQUIRED",
  PRICE_ADJUSTMENT_PENDING_APPROVAL: "PRICE_ADJUSTMENT_PENDING_APPROVAL",
  ...
  PREORDER_SALE_STARTED: "PREORDER_SALE_STARTED",
  SCHEDULED_ACTIVATED: "SCHEDULED_ACTIVATED",
  DISPUTE_RAISED: "DISPUTE_RAISED",
  DISPUTE_RESOLVED: "DISPUTE_RESOLVED",
  ORDER_REASSIGNED: "ORDER_REASSIGNED",
  // Order Rescue Engine events
  ORDER_RESCUE_SEARCHING: "ORDER_RESCUE_SEARCHING",
  ORDER_RESCUE_AUTO_REASSIGNED: "ORDER_RESCUE_AUTO_REASSIGNED",
  ORDER_RESCUE_PRICE_APPROVAL_NEEDED: "ORDER_RESCUE_PRICE_APPROVAL_NEEDED",
  ORDER_RESCUE_FAILED: "ORDER_RESCUE_FAILED",
  ORDER_ESCALATED: "ORDER_ESCALATED",
  DELIVERY_EXCEPTION_REPORTED: "DELIVERY_EXCEPTION_REPORTED",
  SPLIT_DELIVERY_APPROVAL_NEEDED: "SPLIT_DELIVERY_APPROVAL_NEEDED",
  SCHEDULED_ORDER_CUTOFF_REMINDER: "SCHEDULED_ORDER_CUTOFF_REMINDER",
  SCHEDULED_ORDER_STOCK_SHORTAGE: "SCHEDULED_ORDER_STOCK_SHORTAGE",
