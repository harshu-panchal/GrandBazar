...
const TRANSITIONS = {
  ...
  [WORKFLOW_STATUS.PREORDER_HOLD]: new Set([
    WORKFLOW_STATUS.SELLER_PENDING,
  ...
  [WORKFLOW_STATUS.SCHEDULED_HOLD]: new Set([
    WORKFLOW_STATUS.DELIVERY_SEARCH,
    WORKFLOW_STATUS.EXTERNAL_LOGISTICS_PENDING,
    WORKFLOW_STATUS.CUSTOMER_PICKUP_READY,
    WORKFLOW_STATUS.AWAITING_EXTRA_PAYMENT,
  ...
  [WORKFLOW_STATUS.AWAITING_EXTRA_PAYMENT]: new Set([
    WORKFLOW_STATUS.SELLER_PENDING,
    WORKFLOW_STATUS.SELLER_ACCEPTED,
    WORKFLOW_STATUS.SCHEDULED_HOLD,
    WORKFLOW_STATUS.CANCELLED,
  ...
  [WORKFLOW_STATUS.CUSTOMER_PICKUP_READY]: new Set([
    WORKFLOW_STATUS.DELIVERED,
    WORKFLOW_STATUS.CANCELLED,
  ]),
  ...
  [WORKFLOW_STATUS.DELIVERED]: new Set([WORKFLOW_STATUS.DISPUTED]),
  [WORKFLOW_STATUS.DISPUTED]: new Set([WORKFLOW_STATUS.DELIVERED]),
